...
#import "PCHeader.h"
@interface AdvanceApplyDetailVC ()



@property (nonatomic, strong) AdvanceApplyDetailTableView *detailTableView;
...
@implementation AdvanceApplyDetailVC
...
- (AdvanceApplyDetailTableView *)detailTableView {
    if (!_detailTableView) {
        _detailTableView = [[AdvanceApplyDetailTableView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
    }
