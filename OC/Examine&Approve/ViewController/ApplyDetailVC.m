...
#import "PCHeader.h"
@interface ApplyDetailVC ()



@property (nonatomic, strong) ApplyDetailTableView *detailTableView;
...
- (ApplyDetailTableView *)detailTableView {
    if (!_detailTableView) {
        _detailTableView = [[ApplyDetailTableView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
    }
