...
//        self.viewModel.subject.onNext("")
    ...
    func initView() {
        ...
        btn2.setImage(JTBundleTool.getBundleImg(with:"createGroupSelected"), for: .selected)
        btn2.setTitle("    群聊", for: .normal)
        btn2.setTitleColor(kIsFlagShip ? HEX_FFF : HEX_COLOR(hexStr: "#4F525B"), for: .normal)
