...
#import "PCHeader.h"
@interface DiscountApplyDetailVC ()



@property (nonatomic, strong) DiscountApplyDetailTableView *detailTableView;
...
@implementation DiscountApplyDetailVC
...
- (DiscountApplyDetailTableView *)detailTableView {
    if (!_detailTableView) {
        _detailTableView = [[DiscountApplyDetailTableView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
    }
