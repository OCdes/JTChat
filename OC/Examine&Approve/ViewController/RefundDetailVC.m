...
#import "PCHeader.h"
@interface RefundDetailVC ()



@property (nonatomic, strong) RefundTicketDetailTableView *detailTableView;
...
- (RefundTicketDetailTableView *)detailTableView {
    if (!_detailTableView) {
        _detailTableView = [[RefundTicketDetailTableView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
    }
