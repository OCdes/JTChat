...
#import "PCHeader.h"
@interface FreeTicketApplyDetailVC ()



@property (nonatomic, strong) FreeTicketApplyDetailTableView *detailTableView;
...
@implementation FreeTicketApplyDetailVC
...
- (FreeTicketApplyDetailTableView *)detailTableView {
    if (!_detailTableView) {
        _detailTableView = [[FreeTicketApplyDetailTableView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
    }
