...
#import "PCHeader.h"
@interface ExpenseApplyDetailVC ()



@property (nonatomic, strong) ExpenseApplyDetailTableView *detailTableView;
...
@implementation ExpenseApplyDetailVC
...
- (ExpenseApplyDetailTableView *)detailTableView {
    if (!_detailTableView) {
        _detailTableView = [[ExpenseApplyDetailTableView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
    }
